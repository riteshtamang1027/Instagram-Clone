...
<div className="flex items-center  justify-between">
  ...
  <div className="flex items-center gap-2 mb-4">
    <div
      className="rounded-full object-cover cursor-pointer bg-gray-300 animate-pulse h-12 w-12 "
 > </div>
...
<div className="space-y-3 ">
  <div
    className=" rounded-sm object-cover bg-gray-300 animate-pulse  h-[70vh] sm:h-[90vh] w-full cursor-pointer"

...
export default function More({ hidemore }) {
  return (
    <div>
      ...
      <div className="fixed space-y-1  w-max  border-b mx-8 border-b-gray-100 z-50 bottom-12 rounded-xl">
      ...
      <div className="w-64 h-max bg-white shadow-2xl  rounded-b-xl px-2 py-4 space-y-4">
        <p className=" space-y-4 hover:bg-gray-100 w-full rounded-md cursor-pointer p-3">
          Switch accounts
        </p>

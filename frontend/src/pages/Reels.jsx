  ...
  const fetchAllReels = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_SERVER_URL}/Reels`,{
          headers:{
  ...
  return (
    <div className=" space-y-12 sm:mt-8 md:ml-98">
      {Reels?.map((item, index) => (
        <div
          key={index}
          className="md:w-[28vw] md:h-[92vh] w-[100vw] h-screen  sm:rounded-md relative bg-black overflow-hidden"
        >
              ...
              <div className="flex items-center gap-x-4   ">
                ...
                <div>
                  ...
                  <p className="text-xs flex gap-2">
                    ...
                    This is the best music forever
                  </p>
                </div>

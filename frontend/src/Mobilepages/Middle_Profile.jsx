  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2  ">
              ...
              <button className="bg-gray-200 font-semibold text-xs opacity-80 px-12  rounded-md hover:bg-gray-300 cursor-pointer duration-300 whitespace-nowrap">
                Edit profile
              </button>
              <button className="bg-gray-200 text-xs font-semibold opacity-80 px-12  rounded-md hover:bg-gray-300 cursor-pointer duration-300 whitespace-nowrap">
                Share Profile
              </button>
